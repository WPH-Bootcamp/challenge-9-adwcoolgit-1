    ...
    >
      ...
      <div className='flex flex-1 flex-col gap-3 p-5'>
        <div className='flex items-start justify-between gap-3'>
          <div>
            <h3 className='text-xl font-extrabold leading-7 text-(--color-neutral-950)'>
              {restaurant.name}
            </h3>
            <p className='mt-1 text-sm font-medium text-(--color-neutral-600)'>
        ...
        <div className='flex flex-wrap items-center gap-2'>
          {restaurant.categories.length > 0 ? (
            restaurant.categories.map((category) => (
              <span
                key={category}
                className='rounded-full bg-(--color-neutral-100) px-3 py-1 text-xs font-semibold text-(--color-neutral-700)'
              >
                {category}
              </span>
            ))
        ...
        <div className='mt-auto flex items-end justify-between gap-3 pt-2'>
          <div>
            <p className='text-xs font-semibold uppercase tracking-[0.12em] text-(--color-neutral-500)'>
              Price range
            </p>
          ...
          {restaurant.distance !== null ? (
            <p className='text-sm font-semibold text-(--color-neutral-600)'>
